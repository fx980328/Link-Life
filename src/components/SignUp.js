...
import picture_logo from '../images/logo_Link-Life(2).png';
    ...
    <>
      ...
      >
        ...
        style={{
          ...
          <div>
            <img src={picture_logo} alt='link-life logo' className='h-80 w-96' />
            <h2 className='text-3xl font-bold text-center'>소중한 일생을 <span className='text-green-700'>연결</span>하고자 한다면, <br/>가입하세요!</h2>
          </div>
        </div>
